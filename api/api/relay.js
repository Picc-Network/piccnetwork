...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Valida che il destinatario sia uno dei contratti PICC autorizzati
    ...
    // Legge il nonce corrente dell'utente
